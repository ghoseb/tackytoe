...
return (function (){
if(cljs.core.truth_((function (){var and__4843__auto__ = clojure.browser.repl.load_queue;
if(cljs.core.truth_(and__4843__auto__)){
...
var script__$1 = (function (){var G__11307 = script;
(G__11307["type"] = "text/javascript");

(G__11307["onload"] = onload);

(G__11307["onreadystatechange"] = onload);

return G__11307;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__11308 = script__$1;
(G__11308["src"] = src);

return G__11308;
})():(function (){var G__11309 = script__$1;
goog.dom.setTextContext(G__11309,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4855__auto__ = reload;
...
var path_11310 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_11310];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_11310)].join('')];
} else {
}
